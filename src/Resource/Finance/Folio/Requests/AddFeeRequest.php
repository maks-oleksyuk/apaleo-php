...
final readonly class AddFeeRequest extends Request
{
    /** @param 'cancellation-fee'|'no-show-fee' $fee */
    ...
    {
        return '/finance/v1/folio-actions/'.rawurlencode($this->folioId).'/'.$this->fee;
    }
