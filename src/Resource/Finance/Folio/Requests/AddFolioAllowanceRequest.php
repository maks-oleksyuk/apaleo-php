...
final readonly class AddFolioAllowanceRequest extends Request
{
    public function __construct(
        private string $folioId,
        private CreateFolioAllowance $data,
    ...
    {
        return '/finance/v1/folio-actions/'.rawurlencode($this->folioId).'/allowances';
    }
